  ...
  return {
    innerText: {
      ...
      span: {
        ...
        'desc-mimo-model': ['TTS 模型名稱', 'TTS 模型名称', 'TTS model name'],
        'label-mimo-voice': ['語音', '语音', 'Voice'],
        'desc-mimo-voice': ['選擇 MiMo 語音角色，或輸入自定義語音 ID', '选择 MiMo 语音角色，或输入自定义语音 ID', 'Select MiMo voice or enter custom voice ID'],
        'label-mimo-voice-custom': ['自定義語音 ID', '自定义语音 ID', 'Custom Voice ID'],
        'desc-mimo-voice-custom': ['手動輸入 MiMo 語音 ID', '手动输入 MiMo 语音 ID', 'Manually enter MiMo voice ID'],
        'label-mimo-response-format': ['音頻格式', '音频格式', 'Audio Format'],
        'desc-mimo-response-format': ['輸出音頻的格式', '输出音频的格式', 'Output audio format'],
        'label-mimo-speed': ['速度', '速度', 'Speed'],
        'desc-mimo-speed': ['語音播放速度 (0.25 - 4)', '语音播放速度 (0.25 - 4)', 'Speech speed (0.25 - 4)'],
        'label-mimo-style': ['風格', '风格', 'Style'],
        'desc-mimo-style': ['語音風格 (可選)', '语音风格 (可选)', 'Voice style (optional)'],
        'label-mimo-emotion': ['情感', '情感', 'Emotion'],
