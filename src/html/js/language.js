  ...
  return {
    innerText: {
      ...
      button: {
        ...
        'section-model-compare': ['模型對比', '模型对比', 'Model Comparison'],
        'label-compare-ai': ['AI 翻譯對比', 'AI 翻译对比', 'AI Translation Comparison'],
        'desc-compare-ai': ['同一句話跑遍已配置的 AI 引擎，對比譯文品質與延遲', '同一句话跑遍已配置的 AI 引擎，对比译文质量与延迟', 'Run one sentence through all configured AI engines to compare quality and latency'],
        'btn-compare-ai': ['開始對比', '开始对比', 'Compare'],
        'label-compare-tts': ['語音延遲對比', '语音延迟对比', 'Voice Latency Comparison'],
        'desc-compare-tts': ['測試各語音引擎合成同一句話的延遲，可試聽', '测试各语音引擎合成同一句话的延迟，可试听', 'Measure each voice engine\'s synthesis latency for the same sentence; preview available'],
        'btn-compare-tts': ['開始測速', '开始测速', 'Benchmark'],
